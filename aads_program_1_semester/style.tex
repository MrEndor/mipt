...
\newcommand{\Correctness}{\textbf{Корректность.} }
...
\newpagestyle{main}{
  ...
  \setfootrule{.4pt}                       
  \setfoot{\coursedate \; МФТИ ВШПИ}{}{\thepage} 
}      
